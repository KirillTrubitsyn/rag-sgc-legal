...
|---|------|-----|-------|-------------|--------------|---------|
| 1 | [Название файла] | [ФИО] | [Номер] | [Дата выдачи] | [Действует до] | [⬇ Скачать](/api/download?file_id=FILE_ID&filename=ИМЯ_ФАЙЛА) |
| 2 | ... | ... | ... | ... | ... | ... |
...
- Данные уже предварительно извлечены в формате: "Файл: [имя] | ФИО: [фио] | Номер: [номер] | Дата выдачи: [дата] | Действует до: [дата] | file_id: [id]"
- Используй готовые поля ФИО, Номер, Дата выдачи и Действует до напрямую из данных
- Обязательно создавай кликабельные ссылки для скачивания каждого документа используя file_id
- Если дата "Не указано", значит она не содержится в названии файла — выводи как есть
...
|---|----------------|----------------------|
| 1 | [Название файла] | [Скачать](/api/download?file_id=FILE_ID&filename=ИМЯ_ФАЙЛА) |
| 2 | ... | ... |
...
- НЕ пропускай ни одного документа
- Если документов много (>20), всё равно перечисли ВСЕ
- Обязательно создавай кликабельные ссылки для скачивания каждого документа
`;
