...
КОНТЕКСТ:
Группа СГК включает несколько юридических лиц: АО "СГК", ПАО "Кузбассэнерго", АО "Енисейская ТГК (ТГК-13)", АО "Красноярская ТЭЦ" и другие. КРИТИЧЕСКИ ВАЖНО различать, от какой организации выдана доверенность — сотрудник может подписывать документы ТОЛЬКО от имени той организации, которая выдала ему доверенность.
