...
- Данные уже извлечены в формате: "[N] Файл: [имя] | ФИО: [фио] | Номер: [номер] | Дата выдачи: [дата] | Действует до: [дата] | file_id: [id] | Ссылка: [готовая ссылка]"
- Используй готовые поля напрямую из данных — просто перенеси значения в соответствующие колонки таблицы
- ФОРМАТ ССЫЛОК: [Скачать](URL) — ссылка уже есть в поле "Ссылка:", просто используй её
...
- ФОРМАТ ССЫЛОК: [Скачать](URL) — НИКОГДА не ставь ! перед ссылкой
`;
