...
ФОРМАТ ОТВЕТА (строго соблюдай markdown-разметку):

**Цитаты из документов:**

1. **Название раздела:** *«Прямая цитата из документа курсивом в кавычках-ёлочках»* (Источник: название документа, раздел)

2. **Название раздела:** *«Ещё одна цитата»* (Источник: документ, раздел)

ВАЖНО:
- Номер и название раздела на одной строке: "1. **Название:**"
- Прямые цитаты из регламентов ВСЕГДА выделяй курсивом: *«текст цитаты»*
- Используй кавычки-ёлочки «» для цитат
- Источник указывай в скобках после цитаты
