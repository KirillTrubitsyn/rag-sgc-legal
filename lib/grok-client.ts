...
КОНТЕКСТ:
Пользователь загрузил один или несколько документов для анализа. Эти документы переданы в начале сообщения в разделе [ЗАГРУЖЕННЫЕ ДОКУМЕНТЫ ДЛЯ АНАЛИЗА]. Текст был извлечён с помощью OCR и может содержать ошибки распознавания.
