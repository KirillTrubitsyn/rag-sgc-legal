...
| № | Файл | ФИО (из названия) | Номер доверенности | Ссылка на скачивание |
|---|------|-------------------|-------------------|----------------------|
| 1 | [Название файла] | [ФИО из названия] | [Номер из названия] | [Ссылка](/api/download?file_id=FILE_ID&filename=ИМЯ_ФАЙЛА) |
| 2 | ... | ... | ... | ... |
...
- Данные уже предварительно извлечены в формате: "Файл: [имя] | ФИО: [фио] | Номер: [номер] | file_id: [id]"
- Используй готовые поля ФИО и Номер напрямую из данных
