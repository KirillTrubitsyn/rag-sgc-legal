...
- Данные уже извлечены в формате: "Файл: [имя] | ФИО: [фио] | Номер: [номер] | Дата выдачи: [дата] | Действует до: [дата] | file_id: [id] | Ссылка: [готовая ссылка]"
- Используй готовые поля напрямую из данных
- ССЫЛКИ НА СКАЧИВАНИЕ УЖЕ ГОТОВЫ в поле "Ссылка:" — просто оформи их как markdown: [⬇ Скачать](ГОТОВАЯ_ССЫЛКА)
