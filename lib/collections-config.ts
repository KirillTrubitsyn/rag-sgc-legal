...
export const COLLECTIONS_CONFIG: Record<string, CollectionConfig> = {
  ...
  contractForms: {
    ...
    keywords: [
      ...
      'мазут', 'гсм',
      // Условия договора (расторжение, ответственность и т.д.)
      'расторжени', 'расторгнут', 'расторж', 'прекращени', 'прекращ',
      'односторонн', 'внесудебн',
      'ответственност', 'штраф', 'пени', 'неустойк',
      'гарантий', 'гарантия', 'гарантийн',
      'срок поставк', 'сроки поставк', 'срока поставк', 'сроков поставк',
      'условия договор', 'условиях договор', 'условий договор', 'условия контракт',
