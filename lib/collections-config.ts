...
export const COLLECTIONS_CONFIG: Record<string, CollectionConfig> = {
  ...
  poa: {
    ...
    keywords: [
      ...
      // Судебные полномочия (мировые соглашения, представительство в судах)
      'мировое соглашени', 'мировое согл', 'мировой', 'мировому соглашени',
      'примирение', 'примирительн', 'соглашение о примирении',
      'отказ от иска', 'признание иска', 'уменьшение исков',
      'судебное представительств', 'представительство в суд', 'представлять в суд',
  ...
  contractForms: {
    ...
    keywords: [
      ...
      // Типы договоров из коллекции (все падежи)
      'договор оказания услуг', 'договор на оценк', 'договор медосмотр',
      'договор образовательн', 'договор аренд', 'договора аренд',
      'договор поставк', 'договора поставк', 'договором поставк', 'договоре поставк', 'договору поставк',
      'договор подряд', 'договора подряд', 'договором подряд', 'договоре подряд',
      'инженерные изыскан',
      // Поставка мазута/ГСМ (все падежи)
      'поставка мазут', 'поставки мазут', 'поставку мазут', 'поставкой мазут', 'поставке мазут',
      'поставка гсм', 'поставки гсм', 'поставку гсм', 'поставкой гсм',
      'мазут', 'гсм',
      ...
      'условиях договор', 'условий договор', 'условия контракт',
      'обязанности сторон', 'обязательства сторон', 'права сторон',
      'ответственность сторон', 'ответственность по договор', 'ответственност',
      'порядок расчет', 'порядок оплат', 'сроки оплат', 'сроки поставк',
      'срок поставк', 'срока поставк', 'сроков поставк',
      'штрафные санкц', 'неустойк', 'пени по договор', 'штраф', 'пени',
      'гарантийные обязательств', 'гарантии по договор', 'гарантийный срок',
      'гарантий', 'гарантия', 'гарантийн',
      'расторжение договор', 'порядок расторжен', 'прекращение договор',
      'расторжени', 'расторгнут', 'расторж', 'прекращени', 'прекращ',
      'односторонн', 'внесудебн',
      ...
      'пункт договор', 'пунктом договор', 'пункте договор', 'пункты договор',
      'раздел договор', 'разделом договор', 'разделе договор',
      ...
      'что говорит договор', 'по договору', 'согласно договор', 'в договоре',
      'предусмотрен договор', 'основания для', 'условия для',
    ],
  },
  ...
  standardsAndRegulations: {
    ...
    keywords: [
      ...
      // Процедурные вопросы - порядок действий, организация работы
      // (длинные ключевые слова для приоритета над терминами из других коллекций)
      'как организовать', 'организовать подачу', 'порядок подачи',
      'порядок действий', 'алгоритм действий', 'последовательность действий',
      'как мне', 'что мне делать', 'что нужно сделать', 'с чего начать',
      'пошаговая инструкция', 'пошаговый порядок',

      // Претензионно-исковая работа (процедуры, а не условия договоров)
      'подача иска', 'подачу иска', 'подать иск', 'подаче иска',
      'исковое заявлен', 'исковую работ', 'исковая работ', 'исковой работ',
      'претензионная работ', 'претензионную работ', 'претензионной работ',
      'претензионно-исков', 'досудебная работ', 'досудебную работ',
      'судебная работ', 'судебную работ', 'судебной работ',
      'порядок взыскания', 'процедура взыскания', 'как взыскать',
      'обращение в суд', 'обратиться в суд',

      // Организация договорной работы (процессы, а не содержание договоров)
      'организация договорной', 'ведение договорной', 'договорная работа',
      'процесс согласования', 'порядок согласования',
    ],
  },
};
...
export const LIST_ALL_KEYWORDS = [
  ...
  'все договор', 'всех договор', 'всем договор',
  ...
  'какие устав', 'какие регламент', 'какие стандарт', 'какие договор',
  'сколько доверенност', 'сколько документ', 'сколько форм', 'сколько устав',
  'сколько договор', 'сколько регламент', 'сколько стандарт',
  ...
  // Убраны слишком общие фразы типа 'в базе', 'есть в базе' - они срабатывают на вопросы о конкретных документах
  // Вопросы "что есть" (только с "все/какие")
  'что всё есть', 'что у тебя есть всего',
  // Вопросы о наличии полного списка
  'какие есть доверенност', 'какие есть документ', 'какие есть договор',
  'какие имеются', 'что имеется всего',
];
